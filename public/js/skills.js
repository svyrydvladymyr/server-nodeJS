...
//for show widget skills
    let showSkillsList = (res) => {
        ...
        SE.$('edit-skills-wrap').innerHTML = `<i class='far fa-edit' id="edit-skills" onclick='SE.send({"userid":window.location.href}, "/showskills", WSKILLS.showEditSkillsList);'></i>`;
        ...
        if (kilkskills <= 10){
            ...
            <div class="skills-wrap-form" id="">   
                <div class="skills-boks">
                    ...
                    <p id="mess-addskills" style="width:100%; text-align:center; color:#b80000; height:20px;"></p>
                    </div>
                </div> 
            </div>`;
        }
...
//for show edit form for single skill
    let showEditForm = (el) => {
        let opendelform = document.getElementsByClassName('skills-confirm-box').length;
        if (opendelform === 0){
