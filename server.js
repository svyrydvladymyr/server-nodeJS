...
let {registrationUsers, addAvatoDB, savesett, updatesecurity, updaterender} = require('./modules/registration');
...
app.use('/updatesecurity', (req, res) => {updatesecurity(req, res)});
// app.use('/updatesecurity', (req, res) => {updatesecurity(req, res)});
// app.use('/updatesecurity', (req, res) => {updatesecurity(req, res)});
