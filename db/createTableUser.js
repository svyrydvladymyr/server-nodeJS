...
let sql = `CREATE TABLE users (id INT AUTO_INCREMENT PRIMARY KEY,
                                ...
                                facebookemail VARCHAR(60) UNIQUE,
                                instagramemail VARCHAR(60) UNIQUE,
                                googleemail VARCHAR(60) UNIQUE,
                                githubemail VARCHAR(60) UNIQUE,
                                linkedinemail VARCHAR(60) UNIQUE,
                                twitteremail VARCHAR(60) UNIQUE,
                                ava VARCHAR(255),
